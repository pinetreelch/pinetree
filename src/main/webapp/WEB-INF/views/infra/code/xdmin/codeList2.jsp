								...
								<div class="border" style="margin: 15px; border-radius: 5px; padding: 10px;">
									...
									<select id="shOption" name ="shOption" class="form-select" aria-label="Default select example" style="width: 200px; margin:0; display:inline-block; margin-top: 20px;">
										<option value="0" <c:if test ="${empty vo.shOption}"> selected</c:if>> 검색구분</option>								  		
								  		<option value="1" <c:if test ="${vo.shOption eq 1}"> selected</c:if>>코드 이름 (한글)</option>
								 		<option value="2" <c:if test ="${vo.shOption eq 2}"> selected</c:if>>코드 이름 (영문)</option>
									</select>

									<input  type="text" class="form-control" name="shValue" id="shValue" style="width: 500px; margin-right:10px; display:inline-block; margin-top: 20px;" placeholder="검색어">
											...
											<div class="modal fade" id="exampleModal12" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
											  <div class="modal-dialog">
											    <div class="modal-content">
											      ...
											      <div class="modal-body" style="text-align: left ">
											         이 항목을 더이상 사용하지 않습니다. (uelete) 
											      </div>
											      <div class="modal-footer">
											        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"> 닫기 </button>
											        <button type="button" class="btn btn-primary" id="ueleteBtn"> 확인 </button>
											      </div>
											    </div>
											  </div>
											</div>
