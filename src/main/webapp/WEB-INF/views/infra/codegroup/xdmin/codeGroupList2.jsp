				    ...
				    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
				      <div class="accordion-body">
				        <ul id="accorditem" style="line-height: 2em;">
				         	<li style="text-shadow: 2px 2px 2px #b4b4b4,3px 3px 3px #6a79a3; font-weight: 500;  "><a href="./codeGroupList">코드그룹 관리</a></li>
				         	<li><a href="./codeGroupForm">코드 관리</a></li>
				         	<li><a href="../code/codeList">코드그룹 추가</a></li>
				         	<li><a href="./codeAdd">코드 추가</a></li>
				         </ul>
				      </div>
				    </div>
				  </div>							<!-- 아코디언 아이템 1번 끝 -->
