					...
					<form method ="post" action = "/codeGroup/codeGroupUpdt">
						...
						<div  class="row" style="padding-top: 20px;">
							<div class="col"  style="display: inline-block; width: 500px;">
								이 코드그룹의 시퀀스 = <input name = "cgSeq" type="text" class="form-contro" id="cgSeq" value="<c:out  value="${item.cgSeq}"/>">
							</div>
				...
				<div style="padding-top: 30px;">
						...
						<div style="display:table; width: 100%; padding-bottom:150px;">
								...
								<div style="display:table-cell; text-align: right;">
									...
									<button id="mbtnSvae" type="button" style="background: blue; border:1px solid yellow; border-radius: 4px; color: white; font-size: 13px; width: 35px; height: 35px;" > 
...
<script>
// onclick="location.href='/codeGroup/codeGroupList/'"

// var seq = $("input:hidden[name=cgSeq]");
// var goUrlUpdt = "/codeGroup/codeGroupUpdt";

// $("mbtnSvae").on("click", function(){
// 	if(seq.val() == "")
// })
</script>
</body>
