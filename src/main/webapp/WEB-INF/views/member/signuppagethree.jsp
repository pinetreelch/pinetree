...
<body style="background-color: #EBF6FF">
 	...
 	<div class="container">
 		<div class="row bodylogin" style="margin-top: 60px; margin-bottom: 70px; text-align:center;" >
			...
			<h3 class="findid" style="color:#1E9EFF">회원가입이 완료되었습니다.</h3>
			
			<div class="d-grid" style="margin-top: 12px">
		 		 <button type="button" class="btn btn-primary signupcomplete" style="height: 50px; background-color:#1F8CE6" onclick="location.href='../'">로그인</button>
		 	</div>
 		</div>
	</div>
